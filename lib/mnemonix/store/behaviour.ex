defmodule Mnemonix.Store.Behaviour do
  ...
  # ## Building a Store
  #
  # `Mnemonix.Stores.Map` exists mostly to provide a reference implementation for store developers,
  # demonstrating the minimum necessary to get a store working.
  #
  # `Mnemonix.Stores.ETS` is a good example of a store that requires more complicated initialization logic.
  #
  # `Mnemonix.Stores.Redix` is a good example of a store that overrides optional callbacks
